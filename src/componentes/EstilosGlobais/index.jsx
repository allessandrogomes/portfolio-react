...
const EstilosGlobais = createGlobalStyle`
    @font-face {
        font-family: 'DM Sans';
        src: url('/fontes/DM-Sans/DMSans_18pt-ExtraBold.ttf') format('truetype');
        font-weight: 600;
    }

    @font-face {
        font-family: 'DM Sans';
        src: url('/fontes/DM-Sans/DMSans_18pt-Light.ttf') format('truetype');
        font-weight: 100;
    }
    ...
    :root {
        ...
        --darkMode-icone: url('/imagens/cabecalho/moon-darkmode-icon.svg');
        --cabecalho-cor: #ececec;
        --texto-cor-primaria: #666666;
        --texto-cor-secundaria: #42446e;
        --github-icon: url('/imagens/cabecalho/github-light-icon.svg');
        --linkedin-icon: url('/imagens/cabecalho/linkedin-ligth-icon.svg');
        --card-cor: #ffffff;
        ...
        --contato-cor: #42446e;
        --github-footer-icon: url('/imagens/rodape/github-ligth-icon-footer.png');
        --linkedin-footer-icon: url('/imagens/rodape/linkedin-ligth-icon-footer.png');
    }

    .dark-mode {
        --fundoPrincipal-cor: #191919;
        --darkMode-icone: url('/imagens/cabecalho/sun-darkmode-icon.png');
        --cabecalho-cor: #222222;
        --texto-cor-primaria: #a7a7a7;
        --texto-cor-secundaria: #d9d9d9;
        --github-icon: url('/imagens/cabecalho/github-dark-icon.svg');
        --linkedin-icon: url('/imagens/cabecalho/linkedin-dark-icon.svg');
        --card-cor: #363636;
        ...
        --contato-cor: #a7a7a7;
        --github-footer-icon: url('/imagens/cabecalho/github-dark-icon.svg');
        --linkedin-footer-icon: url('/imagens/cabecalho/linkedin-dark-icon.svg');
    }
